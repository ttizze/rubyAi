...
(function() {
    ...
    */
    ...
    ea("WeakMap", function(a) {
        ...
        var h = 0,
            g = function(l) {
                this.R = (h += Math.random() + 1)
                    .toString();
                if (l) {
                    l = ia(l);
                    for (var n; !(n = l.next())
                        .done;) n = n.value, this.set(n[0], n[1])
                }
            };
    ...
    ea("Map", function(a) {
        if (function() {
                ...
                try {
                    ...
                    p = n.next();
                    return p.done || 4 != p.value[0].x || "t" != p.value[1] || !n.next()
                        .done ? !1 : !0
                } catch (r) {
                    return !1
                }
        ...
        var b = new WeakMap,
            c = function(g) {
                ...
                if (g) {
                    g = ia(g);
                    for (var l; !(l = g.next())
                        .done;) l = l.value, this.set(l[0], l[1])
                }
            };
        ...
        c.prototype.forEach = function(g, l) {
            for (var n = this.entries(), p; !(p = n.next())
                .done;) p = p.value, g.call(l, p[1], p[0], this)
        };
    ...
    ea("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if ("function" == typeof f) {
                b = f.call(b);
                for (var h = 0; !(f = b.next())
                    .done;) e.push(c.call(d, f.value, h++))
            } else
    ...
    var ub = {},
        wb = new vb("about:invalid#zClosurez", ub);
    var xb = {},
        yb = function(a, b) {
            this.g = b === xb ? a : "";
            this.Ra = !0
    ...
    var Ab, Bb;
    a: {
        for (var Cb = ["CLOSURE_FLAGS"], Db = q, Eb = 0; Eb < Cb.length; Eb++)
    ...
    var cc = function(a) {
        ...
        ec = function(a, b, c) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
                ...
                for (var d = dc(a), e = cc(a), f = e.length, h = 0; h < f; h++) b.call(c, e[h], d && d[h], a)
        };
    ...
    hc.prototype.remove = function(a) {
        ic(this);
        a = String(a);
        return this.g.has(a) ? (this.s = null, this.m = Ja(this.m) - this.g.get(a)
            .length, this.g.delete(a)) : !1
    };
    ...
    k.oa = function(a) {
        ic(this);
        var b = [];
        if ("string" === typeof a) jc(this, a) && (b = b.concat(this.g.get(String(a))));
        else {
    ...
    k.set = function(a, b) {
        ...
        this.s = null;
        a = String(a);
        jc(this, a) && (this.m = Ja(this.m) - this.g.get(a)
            .length);
        this.g.set(a, [b]);
        this.m = Ja(this.m) + 1;
        return this
    ...
    */
    ...
    var tc = new sc("OFF", Infinity),
        uc = new sc("SEVERE", 1E3),
        vc = new sc("WARNING", 900),
        wc = new sc("CONFIG", 700),
        xc = new sc("FINE", 500),
        yc = function() {
            this.clear()
        },
    ...
    var fd = Lb(),
        ...
        jd = cd(),
        kd = $c() ? "Windows" === Hb.platform : z("Windows"),
        ld = $c() ? "Android" === Hb.platform : z("Android"),
        md = ad(),
        nd = z("iPad"),
        od = z("iPod"),
        pd = bd(),
    ...
    var zd = function(a) {
        ...
        Dd = function(a) {
            return Zc(a, Uc, Xc) ? a : a instanceof A ? Ad(Pb(a)
                .toString()) : a instanceof A ? Ad(Pb(a)
                .toString()) : Ad(String(String(a))
                .replace(Bd, Cd), zd(a))
        },
        Ad = function(a) {
            function b(c) {
...
": "&#8233;"
    ...
    */
        ...
        if (Ed["extension.translation"]) b = Ed["extension.translation"]({
            ...
            if (d)
                if (e) {
                    ...
                    l += '</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' +
                        Dd(d) + '</div><br><div class="gtx-language">' + Dd(h) + '</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + Dd(e) + "</div>";
                    if (b) {
                        ...
                        for (e = 0; e < d; e++) {
                            ...
                            if (c)
                                for (f = f.terms, h = f.length, g = 0; g < h; g++) l += (0 != g ? ", " : "") + Dd(f[g]);
                            else
                                for (f = f.terms, h = f.length, g = 0; g < h; g++) n = f[g], l += 3 > g ? (0 != g ? ", " : "") + Dd(n) : "";
                            l += "</td></tr>"
                        }
                        l +=
                            "</table>"
    ...
    var te = /^<(body|caption|col|colgroup|head|html|tr|td|th|tbody|thead|tfoot)>/i,
        re = {};
    var ue = Mb(),
        ve = ad() || z("iPod"),
        xe = z("iPad"),
        ye = z("Android") && !(Nb() || Mb() || Lb() || z("Silk")),
        ze = Nb(),
    ...
    var Ke = function(a) {
        ...
        Le = function(a) {
            return a.classList ? a.classList : Ke(a)
                .match(/\S+/g) || []
        },
        Me = function(a, b) {
    ...
    var Ve = function(a, b) {
        ...
        af = function(a) {
            for (var b = new Te(0, Infinity, Infinity, 0), c = Sd(a), d = c.g.body, e = c.g.documentElement, f = Zd(c.g); a = Ze(a);)
                if (!(B && 0 == a.clientWidth ||
                        id && 0 == a.clientHeight && a == d) && a != d && a != e && "visible" != Ve(a, "overflow")) {
                    var h = $e(a),
                        g = new D(a.clientLeft, a.clientTop);
                    h.x += g.x;
                    h.y += g.y;
        ...
        $e = function(a) {
            ...
            d = !B || 9 <= Number(yd) || be(Sd(d)
                .g) ? d.documentElement : d.body;
            if (a == d) return c;
            a = Ye(a);
            b = ae(Sd(b)
                .g);
    ...
    var Nf = "closure_listenable_" + (1E6 * Math.random() | 0),
        Of = function(a) {
            return !(!a || !a[Nf])
        };
    var Pf = 0;
    ...
    Sf.prototype.add = function(a, b, c, d, e) {
        ...
        a = this.g[f];
        a || (a = this.g[f] = [], this.m++);
        var h = Tf(a, b, d, e); - 1 < h ? (b = a[h], c || (b.Wa = !1)) : (b = new Qf(b, this.src, f, !!d, e), b.Wa = c, a.push(b));
        return b
    };
    ...
    var Wf = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        bg = function(a, b, c, d, e, f) {
            ...
            else if (a.attachEvent) a.attachEvent(eg(b.toString()), d);
        ...
        gg = function(a, b, c, d, e) {
            ...
            else d = xa(d) ? !!d.capture : !!d, c = ag(c), Of(a) ? a.s.remove(String(b), c, d, e) : a && (a = cg(a)) && (b = Vf(a, b, c, d, e)) && hg(b)
        },
        hg = function(a) {
    ...
    var I = function(a, b) {
        ...
        e = !0;
        if (d)
            for (var f = d.length - 1; !b.u && 0 <= f; f--) {
                var h = b.m = d[f];
                e = lg(h, c, !0, b) && e
            }
        b.u || (h = b.m = a, e = lg(h, c, !0, b) && e, b.u || (e = lg(h, c, !1, b) && e));
        if (d)
            for (f = 0; !b.u && f < d.length; f++) h = b.m = d[f], e = lg(h, c, !1, b) && e;
        return e
    };
    ...
    var mg = function(a, b, c) {
        if ("function" === typeof a) c && (a = t(a, c));
    ...
    var qg = function(a, b, c, d, e, f) {
        if (Array.isArray(c))
            for (var h = 0; h < c.length; h++) qg(a, b, c[h], d, e, f);
        else d = d || a.handleEvent, e = xa(e) ? !!e.capture : !!e, f = f || a.U || a, d = ag(d), e = !!e, c = Of(b) ? Vf(b.s, String(c), d, e, f) : b ? (b = cg(b)) ? Vf(b, c, d, e, f) : null : null, c && (hg(c), delete a.B[c.key]);
        return a
    };
    ...
    var tg = function(a) {
        ...
        sg = /^(?:abbr|acronym|address|b|em|i|small|strong|su[bp]|u)$/i,
        rg = /<[!\/]?([a-z0-9]+)([\/ ][^>]*)?>/gi;
    function ug(a, b) {
        if (b instanceof vb) b instanceof vb && b.constructor === vb ? b = b.g : (Ia("expected object of type SafeUrl, got '" + b + "' of type " + va(b)), b = "type_error:SafeUrl");
        else {
            b: if (Lc) {
                try {
                    var c = new URL(b)
    ...
    wg.prototype.pa = function() {
        if (!this.s) Ag(this), this.F = this.m = null;
        else if (!(this.m && this.g && he(this.g.D(), this.s)) || this.m.getAttribute("data-tooltip-unhoverable")) {
            ...
            if (!this.m && a && (this.m = a, !(a.getAttribute("data-tooltip-only-on-overflow") && a.offsetWidth >= a.scrollWidth &&
                ...
                if (a.getAttribute("data-tooltip-contained"))
                    for (var d = Vd(a), e = 0; e < d.length; e++) {
                        if (d[e].parentNode == a) {
                            c = d[e].cloneNode(!0);
                            break
                        }
    ...
    wg.prototype.Y = function(a, b, c, d, e, f) {
        ...
        if (b instanceof A) {
            ...
            for (fe(this.g.g); d = b.firstChild;) this.g.g.appendChild(d);
        this.u.m = a;
        this.u.F()
    };
    var Ag = function(a) {
    ...
    k.uc = function(a) {
        if (id || gd)
            if (17 == this.S && !a.ctrlKey || 18 == this.S && !a.altKey || jd && 91 == this.S && !a.metaKey) this.ia = this.S = -1; - 1 == this.S && (a.ctrlKey && 17 != a.keyCode ? this.S = 17 : a.altKey && 18 != a.keyCode ? this.S = 18 : a.metaKey && 91 != a.keyCode && (this.S = 91));
    ...
    k.lb = function(a, b) {
        ...
        } else if (B && (c = c ? "on" : "", a.setAttribute("unselectable", c), b))
    ...
    J.prototype.ha = function() {
        ...
        this.g.cc(this);
        this.P & -2 && (this.bb && kh(this, !0), this.P & 32 && (a = this.D())) && (b = this.K || (this.K = new Jg), b.attach(a), Tg(this)
            .listen(b, "key", this.vc)
            .listen(a, "focus", this.tc)
            .listen(a, "blur", this.ac))
    };
    var kh = function(a, b) {
        var c = Tg(a),
            d = a.D();
        b ? (c.listen(d, hh.ob, a.Pa)
            .listen(d, [hh.pb, hh.Tb], a.Qa)
            .listen(d, "mouseover", a.Ua)
            .listen(d, "mouseout", a.Da), a.V != Ua && c.listen(d, "contextmenu", a.V), B && !a.N && (a.N = new nh(a), Ff(a, u(Ef, a.N)))) : (qg(qg(qg(qg(c, d, hh.ob, a.Pa), d, [hh.pb, hh.Tb], a.Qa), d, "mouseover", a.Ua), d, "mouseout", a.Da), a.V != Ua && qg(c, d, "contextmenu", a.V), B && (Ef(a.N), a.N = null))
    };
    ...
    k = J.prototype;
    k.Pa = function(a) {
        this.isEnabled() && (L(this, 2) && qh(this, !0), 0 != a.g.button || jd && a.ctrlKey || (L(this, 4) && ph(this, !0), this.g && this.g.Rb(this) && this.D()
            .focus()));
    ...
    var nh = function(a) {
        ...
        Ff(this, u(Ef, this.s));
        a = Sg(this.m);
        this.s.listen(a, hh.ob, this.B)
            .listen(a, hh.pb, this.F)
            .listen(a, "click", this.u)
    };
    w(nh, H);
    ...
    Bh.prototype.xa = function(a) {
        ...
        if (Ed["jfk.templates.button.strict"]) var d = Ed["jfk.templates.button.strict"](c, void 0);
        else {
            c = c || {};
            var e = c.attributes;
            d = c.content;
    ...
    w(N, jg);
    N.prototype.m = Fc(Gc(), "goog.net.XhrIo")
        .s;
    var ci = /^https?$/i,
        di = ["POST", "PUT"],
        ei = [],
    ...
    N.prototype.send = function(a, b, c, d) {
        ...
        b =
            ia(c);
        for (d = b.next(); !d.done; d = b.next()) c = ia(d.value), d = c.next()
            .value, c = c.next()
            .value, this.g.setRequestHeader(d, c);
    ...
    var mi = function(a) {
            if (a.u && "undefined" != typeof ta)
                if (a.V[1] && 4 == ni(a) && 2 == a.sa()) Jc(a.m, gi(a, "Local request error detected and ignored"));
                else if (a.M && 4 == ni(a)) mg(a.na, 0, a);
            else if (I(a, "readystatechange"), 4 == ni(a)) {
                Jc(a.m, gi(a, "Request complete"));
                a.u = !1;
                try {
                    if (oi(a)) I(a, "complete"), I(a, "success");
                    else {
                        try {
    ...
    var oi = function(a) {
            ...
            if (!c) {
                if (b = 0 === b) a = String(a.F)
                    .match(fc)[1] || null, !a && q.self && q.self.location && (a = q.self.location.protocol.slice(0, -1)), b = !ci.test(a ? a.toLowerCase() : "");
                c = b
            }
            return c
        },
    ...
    function yi(a, b) {
        x(0 <= Object.getOwnPropertyNames(a)
            .indexOf("internalJsprotoWrapper"));
        return a.dc = b
    };
    var zi, Ai, Bi, Ci, Di, Ei, Fi, Gi, Hi;
    if ("function" === typeof Symbol && "symbol" === typeof Symbol()) {
        var Ii = Symbol("bitset"),
            Ji = Symbol("pivotFieldNumber"),
            Ki = Symbol("descriptor"),
            Li = Symbol("unparsedFields"),
            Mi = Symbol("wrapper");
        zi = function(a, b) {
            a[Ii] = Ai(a) | b
        };
    ...
    m(Yi, Wi);
    var $i = function(a) {
        a && a.length ? a = new Yi(Ma(a)
            .slice()) : (Zi || (Zi = new Yi(Vi)), a = Zi);
        return a
    };
            ...
            if (x(a.hasOwnProperty(f))) {
                ...
                if (null != g) {
                    ...
                    if (h.A) e.kb = h.A, l = function(n) {
                        ...
                        Ia("Unexpected value " + g);l = void 0
                    }
                    null != l && Si(d, h.i, l)
                }
            }
    ...
    function S(a, b, c) {
        b instanceof Uint8Array ? b = '"' + [].concat(ja(b))
            .map(function(d) {
    ...
    var Z = function(a, b) {
        a = a || [];
        if (Bi(a)) b && b > a.length && !Ri(a) && Ei(a, b), Hi(a, this);
        else {
    ...
    var Nl = ha(["margin-left: 0px;"]),
        Ol = ha(["color: #A2A2A2; float: right; padding-top: 16px;"]),
        Ph = new Oh,
        Pl = function() {},
        Ql = function(a, b, c, d) {
            if ("" != a) {
    ...
    Pl.prototype.g = function(a, b, c, d) {
        if (null != d) {
            for (var e = d.src, f = Qh(), h = [], g = [], l = d.sentences, n = 0; n < l.length; n++) h.push(l[n].orig), g.push(l[n].trans);
            h = h.join("");
            g = g.join("");
            ...
            a ? (a = E("more"), ug(a, Tc(e)), c = new Ch("", void 0, 4), e = E("new-translation"), Ug(c, e), hf(E("new-translation"), !0), c = E("translate-page"), ie(a, Gh("MSG_OPEN_IN_TRANSLATE")), c.className = "gtx-a", e = Pc(Nl), c.style.cssText = zb(e), hf(a, !0)) : (a = de(document, "a"), a.id = "off", a.className = "gtx-a", a.setAttribute("target", "_blank"), ie(a, Gh("MSG_FOOTER_OPTIONS")
                .toUpperCase()), ug(a, Tc(chrome.runtime.getURL("options.html"))), ee(c, a), a = de(document, "a"), a.id = "more", a.setAttribute("class",
    ...
    var Wl = Pl.T(),
        Xl = chrome.extension.getBackgroundPage();
    ...
    var Yl = function() {
        ...
        Zl = function() {
            ...
            $f(a, "click", function() {
                Xl.translate.getTranslateManager()
                    .attach(b.id);
                window.close()
            })
        },
